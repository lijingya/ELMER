...
#' @param strand A boolean to specific strands. If true, strand column will be filled as input. If false, strand column will be filled "*""
...
sequenceLen <- data.frame(chr=c("chr1","chr1_gl000191_random","chr1_gl000192_random","chr2","chr3","chr4","chr4_gl000193_random","chr4_gl000194_random","chr5",
                            "chr6","chr7","chr7_gl000195_random", "chr8","chr8_gl000196_random","chr8_gl000197_random",
                            "chr9","chr9_gl000198_random","chr9_gl000199_random","chr9_gl000200_random","chr9_gl000201_random",
                            "chr10","chr11","chr11_gl000202_random","chr12","chr13","chr14","chr15","chr16","chr17","chr17_gl000203_random","chr17_gl000204_random",
                            "chr17_gl000205_random", "chr17_gl000206_random","chr18","chr18_gl000207_random","chr19","chr19_gl000208_random","chr19_gl000209_random",
                            "chr20", "chr21", "chr21_gl000210_random", "chr22","chrX","chrY","chrM", "chrUn_gl000211","chrUn_gl000212","chrUn_gl000213",
                            "chrUn_gl000214","chrUn_gl000215","chrUn_gl000216","chrUn_gl000217","chrUn_gl000218","chrUn_gl000219","chrUn_gl000220",
                            "chrUn_gl000221","chrUn_gl000222","chrUn_gl000223","chrUn_gl000224","chrUn_gl000225", "chrUn_gl000226", "chrUn_gl000227",
                            "chrUn_gl000228","chrUn_gl000229","chrUn_gl000230","chrUn_gl000231","chrUn_gl000232","chrUn_gl000233","chrUn_gl000234",
                            "chrUn_gl000235","chrUn_gl000236","chrUn_gl000237","chrUn_gl000238","chrUn_gl000239","chrUn_gl000240",
                            "chrUn_gl000241", "chrUn_gl000242", "chrUn_gl000243","chrUn_gl000244","chrUn_gl000245","chrUn_gl000246","chrUn_gl000247",
                            "chrUn_gl000248","chrUn_gl000249"  ),
                          Length=c(249250621,106433,547496,243199373,198022430,191154276, 189789,191469,180915260,171115067,159138663,182896,146364022,
                                   38914,37175,141213431,90085,169874, 187035, 36148,135534747,135006516,40103,133851895,115169878,107349540,102531392,
                                   90354753,81195210,37498,81310, 174588,41001,78077248, 4262, 59128983,92689,159169,63025520,48129895,27682,51304566,
                                   155270560,59373566,16569,166566,186858,164239,137718,172545,172294,172149,161147,179198,161802,155397,186861, 180455,
                                   179693,211173,15008, 128374,129120,19913,43691,27386,40652,45941, 40531,34474,41934, 45867, 39939,33824,41933,42152,
...
#' @param save if save is false, function will return a bed format data.frame. if save is true, fn parameter need to be specific and it output bed file in the path you specified in fn.
...
#' Generate random loci of genome.
#' @param x GRange object which you want to identify distal elements from.
#' @param TSS.range GRange object which contain promoter infomation
#' @param ignore.strand A boolean which to specific if ignore strand or not.
