...
Probe <- get.feature.probe(feature = NULL, genome = "hg19", met.platform = "450K", rm.chr = paste0("chr",c(2:22,"X","Y")))
...
| percentage        | A number ranging from 0 to 0.5 specifying the percentage of samples in groups U (unmethylated) and M (methylated) used to link probes to genes. Default is 0.2 (lowest quintile samples will be in the U group and the highest quintile samples in the M group).                                                                                                                                                                                                                                             |
...
Hypo.pair <- get.pair(data = data,
                      ...
                      group2 = "Solid Tissue Normal",
                      nearGenes = nearGenes,
                      percentage = 0.2, # Percentage of samples to use in both groups U/M
...
compare the average DNA methylation at all distal enhancer probes within $\pm$ 100bp 
...
```{r results='hide', echo=TRUE, message=FALSE, warning=FALSE, fig.height=10, fig.cap="Each scatter plot shows the methylation level of an example  probe cg19403323 in all LUSC samples plotted against the expression of one of  20 adjacent genes."}
scatter.plot(data,
...
```{r results='hide', eval=TRUE,fig.height=10,  fig.cap="The schematic plot shows probe colored in blue and the location of nearby 20 genes. The genes significantly linked to the probe  were shown in red.", message=FALSE, warning=FALSE}
