...
nearGenes <- GetNearGenes(data = data, probes = Sig.probes, cores = detectCores()/2)

## Identify significant probe-gene pairs
Hypo.pair <- get.pair(data = data,
                      nearGenes = nearGenes,
                      permu.dir = "result/permu",
                      permu.size = 10, # Please set to 100000 to get significant results
                      pvalue = 0.01,   # Please set to 0.001 to get significant results
                      calculate.Pe = TRUE,
                      Pe = 0.1,
