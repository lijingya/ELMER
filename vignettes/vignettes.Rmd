...
`createMAE`  function by specifying option TCGA=TRUE.
...
12. diffExp: A logic. Default is FALSE. If TRUE, t test will be applied to test whether putative target gene are differentially expressed between two groups.
